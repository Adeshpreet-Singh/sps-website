...
export default function ReviewsClient() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-dark-surface">
      ...
      />
      {/* Hero */}
      <section aria-label="Reviews hero" className="relative overflow-hidden py-16 sm:py-20 lg:py-28">
        {/* Cursor glow effect */}
        <CursorGlow />
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 stagger-children" role="list" aria-label="Customer reviews">
            {testimonials.map((t, idx) => (
              <div
                ...
                className={`group relative rounded-2xl bg-white dark:bg-dark-surface p-6 sm:p-8 shadow-card dark:shadow-dark-card ring-1 ring-border dark:ring-dark-border transition-all duration-500 hover:shadow-card-hover dark:hover:shadow-dark-card-hover hover:-translate-y-0.5 card-tilt reveal-hidden ${gridVisible ? "reveal-visible" : ""} reveal-delay-${(idx % 3) + 1} motion-reduce:transition-none motion-reduce:transform-none focus-within:ring-2 focus-within:ring-accent focus-within:ring-offset-2 focus-within:ring-offset-white dark:focus-within:ring-offset-dark-surface`}
              >
