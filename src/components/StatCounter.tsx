...
export default function StatCounter({
  ...
  if (variant === "card") {
    return (
      <div
        className={`relative bg-white dark:bg-dark-surface rounded-xl p-6 text-center shadow-card dark:shadow-dark-card dark:border dark:border-dark-border hover:shadow-card-hover dark:hover:border-accent/30 transition-all motion-reduce:transition-none reveal-scale-hidden ${
