          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="mt-5 flex items-center gap-3">
              <a
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white/70 transition-all duration-200 hover:bg-accent hover:text-white hover:scale-110 motion-reduce:transition-none motion-reduce:transform-none"
              >
              ...
              {services.map((service) => (
                <li key={service.slug}>
                  <Link
                    ...
                    className="block py-2 text-sm text-white/70 transition-all duration-200 hover:text-accent hover:translate-x-1 motion-reduce:transition-none link-underline min-h-[40px] flex items-center animate-fade-in"
                  >
                    {service.title}
                  </Link>
                </li>
            ...
            <ul className="mt-3 flex flex-col gap-2 text-sm text-white/70">
              <li>
                <a
                  ...
                  className="flex items-center gap-2.5 py-2 transition-all duration-200 hover:text-accent hover:translate-x-1 motion-reduce:transition-none min-h-[40px]"
                >
                  <Phone
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-3 px-4 py-4 text-center text-xs text-white/70 dark:text-dark-text-muted sm:flex-row sm:justify-between sm:text-left sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
            ...
            {legalLinks.map((link) => (
              <Link
                key={link.label}
                href={link.href}
                className="hover:text-accent transition-colors duration-200 motion-reduce:transition-none"
              >
                {link.label}
              </Link>
            ))}
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-white/70 transition-all duration-200 hover:bg-accent hover:text-white hover:scale-110 motion-reduce:transition-none motion-reduce:transform-none"
            >
