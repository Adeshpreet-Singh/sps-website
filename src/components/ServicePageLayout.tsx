    ...
    <div className="flex flex-col">
      ...
      <section aria-label="What's included" className="bg-surface dark:bg-dark-surface px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28">
        <ScrollReveal className="mx-auto max-w-5xl">
          ...
          <div className="mt-12 rounded-2xl bg-white dark:bg-dark-surface p-6 shadow-card dark:shadow-dark-card dark:border dark:border-dark-border sm:p-8 lg:p-10 hover:shadow-card-hover dark:hover:shadow-dark-card-hover transition-shadow duration-300 motion-reduce:transition-none">
